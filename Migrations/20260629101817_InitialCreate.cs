        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cabinets = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Request_date = table.Column<DateOnly>(type: "date", nullable: false),
                    Request_time = table.Column<TimeOnly>(type: "time without time zone", nullable: false),
                    ...
                    Feedback = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    UserId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Request_Status_Status_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestServices", x => new { x.RequestId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_RequestServices_Request_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Request",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RequestServices_Service_ServiceId",
